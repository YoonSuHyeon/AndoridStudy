...
public class GoogleOcrActivitiy extends AppCompatActivity implements Serializable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_googleocr);//activity_search_prescription
    ...
    private class LableDetectionTask extends AsyncTask<Object, Void, String> {
        private final WeakReference<GoogleOcrActivitiy> mActivityWeakReference;
        private Vision.Images.Annotate mRequest;
        ProgressDialog progressDialog = new ProgressDialog(GoogleOcrActivitiy.this);
        LableDetectionTask(GoogleOcrActivitiy activity, Vision.Images.Annotate annotate) {
        ...
        protected void onPostExecute(String result) { // 객체에서 문자 추출한 결과: result
            GoogleOcrActivitiy activity = mActivityWeakReference.get();
